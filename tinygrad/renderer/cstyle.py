...
class MetalRenderer(CStyleLanguage):
  device = "METAL"
  shared_max = 32768
  tensor_cores=[TensorCore(st1_pattern=(((1,1),(0,1),(0,2),(1,2),(0,4)),((0,0),(0,3),(1,3),(1,0))),reduce_axes=[(0,2),(1,2),(2,2)],dims=(8,8,8),
    st2_pattern=(((0,0),(1,0),(1,1),(0,3),(1,2)),((0,1),(0,2),(0,4),(1,3))),threads=[(0,2),(1,2),(1,2),(0,2),(1,2)],dtype_in=di,dtype_out=do,
    upcast_axes=([(3,2)],[(3,2)],[(3,2)]),) for di, do in [(dtypes.half, dtypes.float),(dtypes.half, dtypes.half),(dtypes.bfloat16, dtypes.float),
                                             (dtypes.bfloat16, dtypes.bfloat16),(dtypes.float, dtypes.float)]]
