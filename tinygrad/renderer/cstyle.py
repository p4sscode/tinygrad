...
class CUDARenderer(CStyleLanguage):
  ...
  tensor_cores = [TensorCore(dims=(8,16,16), threads=[(0,2),(0,2),(1,2),(1,2),(1,2)], dtype_in=di, dtype_out=do, expanded_shape=(2,2,2,2,2,2),
    st1_pattern=(((1,1),(1,0),(0,2),(0,3),(0,4)),((1,3),(1,5),(1,2),(0,0),(0,1),(1,4))), upcast_axes=([(0,8)],[(2,2),(3,2)],[(3,2),(2,2)]),
  ...
  def render_kernel(self, function_name, kernel, bufs, uops, prefix=None):
    ...
    types_in, types_out = { dtypes.half: "f16", dtypes.bfloat16: "bf16" }, { dtypes.float: "f32", dtypes.half: "f16" }
  ...
  asm("mma.sync.aligned.m{M}n{N}k{K}.row.col.{types_out[dtype_out]}.{types_in[dtype_in]}.{types_in[dtype_in]}.{types_out[dtype_out]}"
