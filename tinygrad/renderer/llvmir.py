...
class LLVMRenderer(Renderer):
  ...
  code_for_op: Dict[Op, Callable] = {
    ...
    BinaryOps.SHL: lambda builder, x, y, dtype: builder.shl(x,y), BinaryOps.SHR: lambda builder, x, y, dtype: builder.lshr(x,y) if is_bool_or_unsigned(dtype) else builder.ashr(x,y), # noqa: E501
