...
class PTXRenderer(Renderer):
  ...
  shared_max = 49152
  tensor_cores = [TensorCore(dims=(8,16,16), threads=[(0,2),(0,2),(1,2),(1,2),(1,2)], dtype_in=di, dtype_out=do, reduce_axes=(8,2)) for (di, do) in ([(dtypes.half, dtypes.float)])] # noqa: E501
